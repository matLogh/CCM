...
int main(int argc, char **argv)
{
    ...
    ROIs.emplace_back(RegionOfInterest(*TEMAT, 2200., 2250., -20., 20.,
    ...
    ROIs.emplace_back(RegionOfInterest(*TEMAT, 7600., 7700., -20., 20.,
                                       7639.)); // ROI1 is the region of interest
    ...
    for (auto &p : projections) { p->Write(); }
